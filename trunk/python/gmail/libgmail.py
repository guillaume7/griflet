...
class GmailAccount:
    ...
    def login(self):
        """
        """
        req = ClientCookie.Request(URL_GMAIL)
	...
	def hasControl(form, name):
        ...
        form['Email'] = self.name
        form['Passwd'] = self._pw
            
        req2 = form.click()
        res2 = ClientCookie.urlopen(req2)
        self._cookieJar.extract_cookies(res2, req2)
    ...
    def _retrievePage(self, urlOrRequest):
        ...
        res = ClientCookie.urlopen(urlOrRequest)
	...
	self._retrievePage(_buildURL(**params))        
